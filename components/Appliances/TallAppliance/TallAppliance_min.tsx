...
const TallAppliance_main = ({ appliance, handleMoveItem, currentPlacement, typeOfAppliance }: Props) => {
  ...
  return (
    <>
      <div className={`w-[96%] max-w-[370px] max-h-full rounded-md md:p-1 border-2 border-black bg-gray-100 relative ${typeOfAppliance === 'tall_fridge' && 'mr-[22px] xs:mx-auto md:mx-0 lg:mx-auto'}`}>

        {typeOfAppliance === 'tall_fridge' ? (
          <>
            {/* Door Start*/}
            {/* Door Compartment */}
            <div className='h-[94%] absolute top-0 right-0 w-full'>
